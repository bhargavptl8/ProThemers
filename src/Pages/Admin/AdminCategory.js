...
const AdminCategory = () => {
    ...
    const formik = useFormik({
        ...
        onSubmit: (values, { setSubmitting }) => {
            ...
            if (id === 0 || id) {
                ...
                axios.patch(`https://pro-themers-backend.onrender.com/admin/category/update/${categoryDataId}`, formData,{ headers: { Authorization: Token } })
                    .then((res) => {
                        console.log(res);
                ...
                axios.post('https://pro-themers-backend.onrender.com/admin/category/create', formData, {
                    headers: {
    ...
    const deleteUserData = (categoryId) => {
        ...
        axios.delete(`https://pro-themers-backend.onrender.com/admin/category/delete/${categoryId}`,  { headers: { Authorization: Token } })
            .then((res) => {
                console.log(res);
                getData();
                toast(res.data.message);
