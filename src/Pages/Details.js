...
const Details = () => {
    ...
    const getProjectData = () => {
        ...
        axios.get(`https://pro-themers-backend.onrender.com/landingpage/project/read/${projectId}`)
            .then((res) => {
                // console.log(res);
    ...
    const downloadUpdate = () => {
        ...
        axios.patch(`https://pro-themers-backend.onrender.com/landingpage/project-details/update/${projectId}`)
            .then((res) => {
                console.log(res);
                getProjectData();
            })
                            ...
                            <Grid item md={7} xs={12} >
                                <Item data-aos="fade-up-right" data-aos-duration="1500">
                                    <Box sx={{ height: isSm ? '370px' : 'auto' }}>
                                        <img src={`https://pro-themers-backend.onrender.com/images/${projectData[0]?.screenshorts[0]}`} width='100%' height='100%' alt={projectData[0]?.projectName} />
                                    </Box>
                                    ...
                                    <Box>
                                        <Stack direction='row' spacing={1.5} alignItems='center' marginBottom='20px' justifyContent='center'>
                                            <Tooltip title="Download" arrow>
                                                <a href={`https://pro-themers-backend.onrender.com/images/${projectData[0]?.projectZip}`} download='download.zip'>
                        ...
                        <Grid container spacing={8} alignItems='center'>
                            <Grid item md={6} xs={12} sx={{ order: { md: 1, xs: 2 } }}>
                                <Box data-aos="flip-left" data-aos-duration="1500">
                                    <img src={`https://pro-themers-backend.onrender.com/images/${projectData[0]?.screenshorts[0]}`} width='100%' alt="" />
                                </Box>
                            </Grid>
                            <Grid item md={6} xs={12} sx={{ order: { md: 2, xs: 1 } }}>
                                <Box className='imgLogo' sx={{ position: 'relative' }}>
                                    ...
                                    These images showcase various aspects of the project, providing visual insights into its key components and accomplishments
                                    </Typography>
                                </Box>
                            </Grid>
                            <Grid item md={6} xs={12} sx={{ order: { md: 3, xs: 4 } }}>
                                <Stack alignItems='flex-end' className='imgLogo2' sx={{ position: 'relative' }}>
                                    <img src={imgLogo} width='50px' alt="imglogo" className='unfound-img-logo' />
                                    <Typography sx={{ marginRight: '20px' }}>A dynamic visualization showcasing the project's innovative solutions in action.</Typography>
                                </Stack>
                                {/* <Box className='imgLogo' sx={{ position: 'relative' }}> */}
                            ...
                            <Grid item md={6} xs={12} sx={{ order: { md: 3, xs: 4 } }}>
                                <Box data-aos="flip-right" data-aos-duration="1500">
                                    <img src={`https://pro-themers-backend.onrender.com/images/${projectData[0]?.screenshorts[1]}`} width='100%' alt="" />
                                </Box>
                            </Grid>
                            <Grid item md={6} xs={12} sx={{ order: { md: 5, xs: 6 } }}>
                                <Box data-aos="flip-left" data-aos-duration="1500">
                                    <img src={`https://pro-themers-backend.onrender.com/images/${projectData[0]?.screenshorts[2]}`} width='100%' alt="" />
                                </Box>
                            </Grid>
                            <Grid item md={6} xs={12} sx={{ order: { md: 6, xs: 5 } }}>
                                <Box className='imgLogo' sx={{ position: 'relative' }}>
                                    <img src={imgLogo} width='50px' alt="imglogo" className='unfound-img-logo' />
                                    <Typography sx={{ marginLeft: '20px' }}>
                                    An image displaying the project's progress, showcasing solutions based on societal circumstances.
                                    </Typography>
                                </Box>
                            </Grid>
